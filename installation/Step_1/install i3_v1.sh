...
sudo apt-get install -y unclutter ristretto tumbler
...
sudo apt-get install -y scrot screenfetch git htop wget sensord sysstat glances
...
sudo apt-get install -y cups cups-pdf ghostscript gsfonts libcups hplip system-config-printer-gnome 
